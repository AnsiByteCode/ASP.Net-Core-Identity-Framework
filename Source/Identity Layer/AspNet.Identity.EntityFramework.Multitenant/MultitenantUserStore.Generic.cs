...
namespace AspNet.Identity.EntityFramework.Multitenant
{
    ...
    public class MultitenantUserStore<TUser, TRole, TKey, TTenantKey, TUserLogin, TUserRole, TUserClaim, TContext>
        //: UserStore<TUser, TRole, TKey, TUserLogin, TUserRole, TUserClaim>
        : UserStore<TUser, TRole, TContext, TKey,TUserClaim,TUserRole,TUserLogin, IdentityUserToken<TKey>>        
